...
```{r, echo = F, fig.align = "center", fig.cap = "Decoding Dairy Diets using NASEM (2021) 'Nutrient Requirements of Dairy Cattle, 8th edition'" }
knitr::include_graphics("images/ddd.png")
