...
```{r, echo = F, out.width = '50%', fig.align = "center", fig.cap = "Figure from Conrad et al., (1964) depicting the transition from physical fill determination of DMI to fuel-sensing."}
knitr::include_graphics("images/image-1323641746.png")
```
...
`r hide("Show an analogy to humans")`
...
**Inclusion of ingredients in diet**  
($w_i$, proportion of diet DM)  
Corn silage 0.4  
Alfalfa silage 0.2  
Other non-forage ingredients 0.4  

**NDF content of ingredients**  
($NDF_i$, % of ingredient DM)  
Corn silage 45%   
Alfalfa silage 42% 
