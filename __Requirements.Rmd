...
```{r, echo = F, fig.align = "center", fig.height = 2, fig.cap = "Which one of us did you have in mind when you formulated our diet?"}
knitr::include_graphics("images/Cow face distribution.jpg")
