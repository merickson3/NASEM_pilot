...
**Think to yourself: **
How do you interpret what you see in the figure? List at least two or three of your impressions. 

:::  

From this figure, we can see that as the size of the cube increases, the ratio of surface area to volume decreases. The same is true for complex shaped objects such as animal bodies! This fact, according to Rubner, affected many of the animal's metabolic processes. 

Still, within the range of weights for adult dairy cattle, the differences in using BW and BW^0.75 can be relatively small. For example, this figure shows the close relationship between BW and BW^0.75 across a range of realistic weights for cattle (dots). The red line illustrates that the relationship is nearly linear, but has a slight curvature.  
...
## Questions
1. Define ratios, percentages, and proportions. 
1. Explain the concept of "basis" and differentiate as-is and DM basis. 
1. How does weighting differ from scaling?
1. What are some ways to describe predictive models? List and define common descriptors.
1. Give two examples of non-linear model forms that are often used in animal nutrition. 
1. What are some examples of constraints we can use in optimization, and how do we represent them mathematically?
1. How do we ensure that inclusion rates for each feed are non-negative and add up to 1 in optimization?
1. What is an example of an unrealistic diet that could be produced by optimization? Why do these occur?
1. What is typically optimized (included in the objective function)? What is possible to optimize?
